...
class ServiceMessage(Message):
    ...
    def id(self) -> str:
        ...
        return str(self._detail.id)

    @property
    def from_(self) -> str:
        """Return the sender address."""
        return str(self._detail.from_)

    @property
    def to(self) -> str:
        """Return the recipient list."""
        return str(self._detail.to)

    @property
    def date(self) -> str:
        """Return the message date."""
        return str(self._detail.date)

    @property
    def subject(self) -> str:
        """Return the message subject."""
        return str(self._detail.subject)

    @property
    def body(self) -> str:
        """Return the message body."""
        return str(self._detail.body)
